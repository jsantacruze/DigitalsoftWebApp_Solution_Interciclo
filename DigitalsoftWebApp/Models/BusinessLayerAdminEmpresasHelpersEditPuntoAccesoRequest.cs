...
{
    /// <summary>
    /// BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest
    /// </summary>
    [DataContract]
        public partial class BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest :  IEquatable<BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest" /> class.
        /// </summary>
        ...
        public BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest(int? puntoId = default(int?), int? puntoSucursalId = default(int?), string puntoDescripcion = default(string), string puntoObservaciones = default(string), bool? puntoActivo = default(bool?), string puntoPrinter01 = default(string), string puntoPrinter02 = default(string), string puntoPrinter03 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest {\n");
        ...
        {
            return this.Equals(input as BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest);
        }

        /// <summary>
        /// Returns true if BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusinessLayerAdminEmpresasHelpersEditPuntoAccesoRequest input)
        {
            if (input == null)
                return false;
