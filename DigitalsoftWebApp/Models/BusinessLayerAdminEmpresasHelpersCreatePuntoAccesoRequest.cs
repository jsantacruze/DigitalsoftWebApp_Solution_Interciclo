...
{
    /// <summary>
    /// BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest
    /// </summary>
    [DataContract]
        public partial class BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest :  IEquatable<BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest" /> class.
        /// </summary>
        ...
        public BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest(int? puntoSucursalId = default(int?), string puntoDescripcion = default(string), string puntoObservaciones = default(string), bool? puntoActivo = default(bool?), string puntoPrinter01 = default(string), string puntoPrinter02 = default(string), string puntoPrinter03 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest {\n");
        ...
        {
            return this.Equals(input as BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest);
        }

        /// <summary>
        /// Returns true if BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BusinessLayerAdminEmpresasHelpersCreatePuntoAccesoRequest input)
        {
            if (input == null)
                return false;
