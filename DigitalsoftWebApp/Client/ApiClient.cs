...
namespace api.digitalsoftec.net.Client
{
    /// <summary>
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = api.digitalsoftec.net.Client.Configuration.Default;
        ...
        {
            Configuration = config ?? api.digitalsoftec.net.Client.Configuration.Default;
